...
public class UpdateStageResultDTO {
  ...
  public UpdateStageResultDTO() {
  }

  public UpdateStageResultDTO(Long stageId, Long vehicleId, LocalDateTime timestamp, Double latitude,
      Double longitude) {
