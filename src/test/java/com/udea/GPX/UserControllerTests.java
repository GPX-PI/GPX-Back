...
//
//        // Act
//        ResponseEntity<User> response = userController.updateUser(userId, updatedUser, null, null);
//
//        // Assert
//        assertEquals(HttpStatus.OK, response.getStatusCode());
//        assertEquals("JuanUpdated", Objects.requireNonNull(response.getBody()).getFirstName());
//    }
//
//    @Test
